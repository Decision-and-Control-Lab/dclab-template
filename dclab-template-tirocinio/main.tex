...
% Il titolo della sezione ("Riferimenti bibliografici" / "References") viene
% scelto automaticamente da babel in base alla lingua impostata in cima al
% file: non serve modificare nulla qui se si passa dall'italiano all'inglese.
