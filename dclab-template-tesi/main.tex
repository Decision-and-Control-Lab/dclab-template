...
\maketitle                                                  %%
%% Liberatoria                                              %%
\input{01-chapters/liberatoria}                             %%
%% Ringraziamenti                                           %%
\input{01-chapters/dedica.tex}                              %%
%% Sommario                                                 %%
\input{01-chapters/sommario.tex}                            %%
%% Indice                                                   %%
\cleardoublepage                                            %%
\setcounter{page}{1}                                        %%
\pagenumbering{Roman}                                       %%
...
\input{01-chapters/capitolo1}
\input{01-chapters/capitolo2}
\input{01-chapters/capitolo3}
\input{01-chapters/capitolo4}
\input{01-chapters/capitolo5}
\input{01-chapters/capitolo6}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% Bibliografia (non modificare)
% Il titolo del capitolo ("Bibliografia" / "Bibliography") viene scelto
% automaticamente da babel in base alla lingua impostata in cima al file:
% non serve modificare nulla qui se si passa dall'italiano all'inglese.
\backmatter
\cleardoublepage
...
\appendix
\input{01-chapters/appendiceA.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}